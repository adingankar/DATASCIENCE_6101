...
The data contains 7043 rows and 21 columns (variables) including the binary target variable called Churn.
There are 3 numerical, 17 categorical variables.
The remaining column contains unique customer id.
There are only 11 missing data points in the TotalCharges column. We remove these as it's a very small percentage of the dataset.
